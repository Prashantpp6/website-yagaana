    ...
    <div id="About" className="about">
      <div className="left">
        ...
        <img 
          ...
          alt="Play Icon" 
          className="play-icon" 
          onClick={() => setPlayState(true)} // Triggers video play on click
        />
      </div>
      <div className="right">
        ...
        <p>
          Embark on a transformative educational journey with our university's comprehensive programs. Our cutting-edge curriculum is designed to empower students with the knowledge, skills, and experiences needed to excel in the dynamic field of education.
        </p>
        <p>
